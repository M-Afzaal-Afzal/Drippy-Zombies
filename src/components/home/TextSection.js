        ...
        <Box sx={{
            ...
            <Container maxWidth={'xxl'}>
                ...
                '-webkit-text-fill-color': 'white',
                    ...
                    <Typography fontWeight={'bold'} fontSize={'2rem'} variant={'body1'}>
                        In addition to your drippy zombie membership, which grants holders play-to-earn and a claimable
                        mystery box, you will be able to change your zombie’s clothing and appearance using content from
